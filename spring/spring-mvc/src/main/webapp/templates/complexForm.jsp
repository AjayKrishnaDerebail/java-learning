                ...
                <div class="card-body">
                    ...
                    <form action="handleComplexForm" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input name="date" type="text" class="form-control" id="exampleDob"
                                   aria-describedby="dobHelp" placeholder="dd/mm/yyyy">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="selectStudent">Select Type</label>
                            <select class="form-control" id="selectStudent" name="type">
